...
>
  <div>
    <div className="relative min-h-[70vh] md:min-h-[85vh] overflow-hidden">
      ...
      >
        <source src="/video/mandb.mp4" type="video/mp4" />
      </video>

      <div className="absolute inset-0 bg-black/70 z-10"></div>

      <div className="absolute flex flex-col w-full h-full justify-center items-center px-10 md:px-20 gap-3 z-20">
        <motion.p
